...
// Build number is incremented with each commit to dev that changes code or is otherwise significant enough to warrant a new version
...
#define K_VERSION "GalaxyOS Neptune 0.1.0-dev+12.0" 
