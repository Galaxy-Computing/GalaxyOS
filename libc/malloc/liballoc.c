// Liballoc Memory Allocator (userspace version) (liballoc.c)
...
void free(void *ptr)
{
    ...
    {
        // TODO: Once liballoc_free is implemented, this can be uncommented
        // For now we don't want to free this because that will cause a memory leak
